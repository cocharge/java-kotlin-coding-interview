...
public class Game {
    ...
    public Result play(Move playerAMove, Move playerBMove) {
        ...
        (playerAMove == Move.SCISSORS && playerBMove == Move.PAPER)||
                        ...
                        ||
                        (playerAMove == Move.Lizard && playerBMove == Move.Spock)||(playerAMove == Move.Lizard && playerBMove == Move.PAPER)
                ||
                        (playerAMove == Move.Spock && playerBMove == Move.SCISSORS)|| (playerAMove == Move.Spock && playerBMove == Move.ROCK)
