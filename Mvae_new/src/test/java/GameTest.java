...
class GameTest {
    ...
    void testPlayerBWins() {
        Game game = new Game();
        assertEquals(Result.WIN, game.play(Move.SCISSORS, Move.ROCK));
        assertEquals(Result.WIN, game.play(Move.Lizard, Move.ROCK));

        assertEquals(Result.WIN, game.play(Move.ROCK, Move.PAPER));
        assertEquals(Result.WIN, game.play(Move.Spock, Move.PAPER));

        assertEquals(Result.WIN, game.play(Move.PAPER, Move.SCISSORS));
        assertEquals(Result.WIN, game.play(Move.Lizard, Move.SCISSORS));

        assertEquals(Result.WIN, game.play(Move.Spock, Move.Lizard));
        assertEquals(Result.WIN, game.play(Move.PAPER, Move.Lizard));

        assertEquals(Result.WIN, game.play(Move.ROCK, Move.Spock));
        assertEquals(Result.WIN, game.play(Move.SCISSORS, Move.Spock));
